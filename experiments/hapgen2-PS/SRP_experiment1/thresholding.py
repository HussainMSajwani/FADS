...
def get_dset(h2s, sim_i):
    P = f"/home/shussain/Simulated_data/28062021_PS/{h2s}/simulation_output{sim_i}"
    return get_dsets_(P)
...
with open("/home/shussain/experiments/hapgen2-PS/SRP_experiment1/thresholding.csv", 'w') as t:
...
for h2s in tqdm(H2S, desc="h2s"):
    for i in trange(1, 11, desc="sim_out"):
        ...
        plt.savefig(f"/home/shussain/experiments/hapgen2-PS/SRP_experiment1/plots/simulation_output{i}/{h2s}/p_manhattan.jpeg")
        plt.clf()
        ae_thresh_plot(dset["ct"])
        plt.savefig(f"/home/shussain/experiments/hapgen2-PS/SRP_experiment1/plots/simulation_output{i}/{h2s}/ae_manhattan.jpeg")
        ...
        for k in tqdm(K, desc="k"):
            ...
            with open("/home/shussain/experiments/hapgen2-PS/SRP_experiment1/thresholding.csv", 'a') as t:
