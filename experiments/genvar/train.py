...
dset = get_dset(f"/home/shussain/Simulated_data/26092021/d_{d}/genVar_{genvar}/h2s_{h2s}/sim_{i}/sim_{i}/PS/output")
...
method.manhattan()
savefig(f"/home/shussain/FADS/experiments/genvar/full_results/results/d_{d}/h2s_{h2s}/genvar_{genvar}/sim_{i}/{args.method}.jpeg")
...
for k in tqdm([5, 25, 100, 300]):
    ...
    with open(f"/home/shussain/FADS/experiments/genvar/full_results/results/d_{d}/h2s_{h2s}/genvar_{genvar}/sim_{i}/n_causals.csv", 'a') as f:
