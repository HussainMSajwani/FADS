...
dset = get_dset(f"/home/shussain/Simulated_data/29072021/{h2s}/sim_{i}/sim_{i}/PS/output")
...
save(f"/home/shussain/FADS/experiments/HSIC/resuls/results/h2s_{h2s}/sim_{i}/importance.npy", method.importance)
#method.manhattan()
#savefig(f"/home/shussain/FADS/experiments/HSIC/resuls/results/h2s_{h2s}/sim_{i}/{args.method}.jpeg")
...
for k in tqdm([5, 25, 100, 300]):
    ...
    with open(f"/home/shussain/FADS/experiments/HSIC/resuls/results/h2s_{h2s}/sim_{i}/n_causals.csv", 'a') as f:
        #print(f"{base},{h2s},{i},{k},{args.method},{svm_auc},{lr_auc}\n")
        #f.writelines(f"{base},{h2s},{i},{k},{args.method},\n")
        f.writelines(f"{base},{h2s},{i},{k},{args.method},{n_causals},{svm_auc},{lr_auc}\n")
