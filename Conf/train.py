...
dset = get_dset(f"/home/shussain/FADS/Conf/Code/Simulation/data/d_{d}/h2s_{h2s}/sim_{i}/PS/output")
...
method.manhattan()
savefig(f"/home/shussain/FADS/Conf/results/d_{d}/h2s_{h2s}/sim_{i}/{args.method}.jpeg")
