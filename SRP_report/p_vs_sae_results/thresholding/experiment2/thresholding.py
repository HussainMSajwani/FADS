...
with open("/home/shussain/final_report/p_vs_sae_results/thresholding/experiment2/thresholding.csv", 'w') as t:
...
for h2s in tqdm(H2S, desc="h2s"):
    for i in trange(1, 11, desc="sim_out"):
        ...
        plt.savefig(f"/home/shussain/final_report/p_vs_sae_results/thresholding/experiment2/plots/simulation_output{i}/{h2s}/p_manhattan.jpeg")
        plt.clf()
        ae_thresh_plot(dset["ct"])
        plt.savefig(f"/home/shussain/final_report/p_vs_sae_results/thresholding/experiment2/plots/simulation_output{i}/{h2s}/ae_manhattan.jpeg")
        ...
        for k in tqdm(K, desc="k"):
            ...
            with open("/home/shussain/final_report/p_vs_sae_results/thresholding/experiment2/thresholding.csv", 'a') as t:
