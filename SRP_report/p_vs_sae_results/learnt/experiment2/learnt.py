...
with open("/home/shussain/final_report/p_vs_sae_results/learnt/experiment2/learnt_representation.csv", 'w') as t:
...
for h2s in tqdm(H2S, desc="h2s"):
    for k in tqdm(K):
        for i in range(1, 11):
            ...
            with open("/home/shussain/final_report/p_vs_sae_results/learnt/experiment2/learnt_representation.csv", 'a') as t:
